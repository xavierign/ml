function final_predictions(INDATA, INQUIZ, OUTPUTFILE)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%      MAIN SCRIPT       %%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
names = {'VarName1' , 'VarName2' , 'VarName3' ,'VarName4' , 'VarName5',...
    ...
    'VarName40',    'VarName41',    'VarName42' ,   'VarName43',...
    'VarName44' ,   'VarName45' ,   'VarName46'  ,  'VarName47' ,   'VarName48' ,...
    'VarName49',    'VarName50',  'VarName51',    'VarName52' ,   'label'};

namesq = {'VarName1' , 'VarName2' , 'VarName3' ,'VarName4' , 'VarName5',...
    'VarName6',    'VarName7',    'VarName8','VarName9', 'VarName10',...
    'VarName11',    'VarName12',    'VarName13',    'VarName14',    'VarName15',...
    'VarName16' ,   'VarName17' ,   'VarName18'   , 'VarName19'  ,  'VarName20',...
    'VarName21' ,   'VarName22','VarName23' ,   'VarName24' ,   'VarName25',...
    ...
    'VarName40',    'VarName41',    'VarName42' ,   'VarName43',...
    'VarName44' ,   'VarName45' ,   'VarName46'  ,  'VarName47' ,   'VarName48' ,...
    'VarName49',    'VarName50',  'VarName51',    'VarName52'};
data = readtable(INDATA);
data.Properties.VariableNames = names;

quiz = readtable(INQUIZ);
quiz.Properties.VariableNames = namesq;
...
export(file_s,'file',OUTPUTFILE,'Delimiter',',')